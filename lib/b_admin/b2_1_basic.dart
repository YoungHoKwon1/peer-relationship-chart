    ...
    return Row(
      children: [
        ...
        children: [
          Container(//메인 프로필
            ...
            child: Row(//사진, 개인정보, 버튼
              children: [Container(//사진
                  ...
                  child: const Text('사진이 들어가야할 곳')//Image(),
              ),
                Container(//개인정보
                  width: 375.5.w,
                  //color: Colors.red,
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text('아이디: 이메일주소',style: TextStyle(fontWeight: FontWeight.w500, fontSize: 20.sp)),
                      Container(
          ...
          Text('우리 유치원 목록', style: TextStyle(fontWeight: FontWeight.w500,fontSize: 22.w, color: const Color(0xFF393838))),
            ...
            children: [
                ...
                child: Row(
                  ...
                  children: [
                    Container(
                      ...
                      child: Text('유치원', style: TextStyle(fontWeight: FontWeight.w500,fontSize: 20.w, color: const Color(0xFF393838))),
                    ),
                    Container(
                      padding: EdgeInsets.only(left: 98.w),
                      child: Text('원장', style: TextStyle(fontWeight: FontWeight.w500,fontSize: 20.w, color: const Color(0xFF393838))),
                    ),
                    Container(
                      padding: EdgeInsets.only(left: 97.w),
                      child: Text('원장연락처', style: TextStyle(fontWeight: FontWeight.w500,fontSize: 20.w, color: const Color(0xFF393838))),
                    ),
                    Container(
                      padding: EdgeInsets.only(left: 136.w),
                      child: Text('주소', style: TextStyle(fontWeight: FontWeight.w500,fontSize: 20.w, color: const Color(0xFF393838))),
                    ),
                    Container(
                      padding: EdgeInsets.only(left: 145.w),
                      child: Text('전화번호', style: TextStyle(fontWeight: FontWeight.w500,fontSize: 20.w, color: const Color(0xFF393838))),
                    ),
                  ],
                ),
              ),
              Container(
                ...
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceAround,
                  children: [
                    Text('튤립유치원', style: TextStyle(fontWeight: FontWeight.w500,fontSize: 20.w, color: const Color(0xFF393838))),
                    Text('홍길동', style: TextStyle(fontWeight: FontWeight.w500,fontSize: 20.w, color: const Color(0xFF393838))),
                    Text('010.1234.5678', style: TextStyle(fontWeight: FontWeight.w500,fontSize: 20.w, color: const Color(0xFF393838))),
                    Text('시흥시 옥길동', style: TextStyle(fontWeight: FontWeight.w500,fontSize: 20.w, color: const Color(0xFF393838))),
                    Text('010.1234.5678', style: TextStyle(fontWeight: FontWeight.w500,fontSize: 20.w, color: const Color(0xFF393838))),
                  ],
                ),
              )
