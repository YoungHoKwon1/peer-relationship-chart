            ...
            child: Row(
                    ...
                    children: [
                      Container(
                          ...
                          height: 177.67.w,
                          margin:
                              EdgeInsets.fromLTRB(54.w, 50.67.w, 0.w, 51.66.w),
                          child: Text('사진123123')
                          ),
                      Container(
                        //개인정보
                        ...
                        child:
                           Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text('아이디: ${contextB2_1_basic.watch<AdminInfo>().email}',
                                  style: TextStyle(
                                      fontWeight: FontWeight.w500,
                                      fontSize: 20.sp)),
                              Container(
                                  margin:
                                      EdgeInsets.fromLTRB(0.w, 25.w, 0.w, 25.w),
                                  child: Text('이름: ${contextB2_1_basic.watch<AdminInfo>().name}',
                                      style: TextStyle(
                                          fontWeight: FontWeight.w500,
                                          fontSize: 20.sp))),
                              Text('연락처: ${contextB2_1_basic.watch<AdminInfo>().phoneNumber}',
                                  style: TextStyle(
                                      fontWeight: FontWeight.w500,
                                      fontSize: 20.sp)),
                            ],
