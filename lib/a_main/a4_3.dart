...
import 'package:peer_relationship_chart/a_main/a4_2.dart';
import 'package:peer_relationship_chart/a_main/a4_4.dart';
import 'package:flutter_svg/flutter_svg.dart';

class A4_3 extends StatefulWidget {
  const A4_3({Key? key}) : super(key: key);
                        ...
                        ElevatedButton(
                          ...
                          onPressed: () {
                            if(this.formKey.currentState!.validate()){
                              ...
                              Navigator.push(
                                context,
                                MaterialPageRoute(builder: (context) => A4_4()),
                              );
                              print('완료');
                            }
...
class ResetPwPageForm extends StatefulWidget {
  const ResetPwPageForm({Key? key}) : super(key: key);
